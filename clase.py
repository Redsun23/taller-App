...
class Trabajador(Empresa):
    ...
    def returnArray2(self):
        return super().returnArray() + [self.direccion, self.telefono, self.fecha_ingreso]
...
class Musica():
    ...
    def pedirDatosCD(rut):
        ...
        while(not NumeroCorrecto):
            ...
            NumeroCorrecto = True
        trabajador = Trabajador(rut,nombre_completo,sexo,cargo,direccion,telefono,fecha_ingreso)
        return trabajador
